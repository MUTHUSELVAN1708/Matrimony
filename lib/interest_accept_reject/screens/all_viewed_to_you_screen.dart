...
class AllViewedToYouScreen extends ConsumerStatefulWidget {
  const AllViewedToYouScreen({super.key});

  @override
  ConsumerState<AllViewedToYouScreen> createState() =>
      _SentProfileScreenState();
}

class _SentProfileScreenState extends ConsumerState<AllViewedToYouScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text(
            'All viewed to You (${interestModelState.viewListToMe.length})',
      ...
      body: EnhancedLoadingWrapper(
        ...
        child: interestModelState.viewListToMe.isEmpty
            ? const Center(
                child: Text(
                  'You haven’t viewed by anyone yet.',
            ...
            : Container(
                ...
                child: ListView.builder(
                  itemCount: interestModelState.viewListToMe.length,
                  shrinkWrap: true,
                  itemBuilder: (context, index) {
                    final filteredInterests =
                        interestModelState.viewListToMe.toList();
                          ...
                          Expanded(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  //         .unShortListUser(interest.userId!);
                                  //     await ref
