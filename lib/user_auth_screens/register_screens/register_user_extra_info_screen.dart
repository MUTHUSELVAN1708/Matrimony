...
class RegisterUserExtraDetailScreen extends ConsumerStatefulWidget {
  @override
  _RegisterUserExtraDetailScreenState createState() =>
      _RegisterUserExtraDetailScreenState();
}

class _RegisterUserExtraDetailScreenState
    extends ConsumerState<RegisterUserExtraDetailScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 12,
                runSpacing: 12,
                children: describeTraits
                    .map((trait) => _buildChip(trait, selectedDescribeTraits))
                    .toList(),
              ),
              ...
              Wrap(
                ...
                runSpacing: 12,
                children: hobbies
                    .map((hobby) => _buildChip(hobby, selectedHobbies))
                    .toList(),
              ),
  ...
  Widget _buildChip(String label, List<String> selectedList) {
    ...
    return FilterChip(
      ...
      backgroundColor:
          isSelected ? AppColors.selectedWrapBacgroundColor : Colors.white,
