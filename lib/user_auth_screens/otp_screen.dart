...
class _OtpScreenState extends ConsumerState<OtpScreen> {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.red[50],
                  image: const DecorationImage(image: AssetImage('assets/otpicon.png')),
  ...
  children: [
    ...
    const SizedBox(width: 8), // Add some space between the text and icon
    SvgPicture.asset(
  ...
  child: ElevatedButton(
    ...
    child: const Text(
      ...
      style: AppTextStyles.secondaryButton,
       ...
       bool success = await  ref.read(registerProvider.notifier).otpVerification();
         if(success){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> const RegisterUserPersonalDetailsScreen()));  
         }
