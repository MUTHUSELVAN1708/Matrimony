...
class IgnoreListsScreen extends ConsumerStatefulWidget {
  const IgnoreListsScreen({super.key});

  @override
  ConsumerState<IgnoreListsScreen> createState() => _BlockListScreenState();
}

class _BlockListScreenState extends ConsumerState<IgnoreListsScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: interestModelState.ignoredLists.isEmpty
          ? Center(
              child: Text(
                'Currently There Are No Profiles Here.',
                style: TextStyle(
          ...
          : EnhancedLoadingWrapper(
              ...
              child: ListView.builder(
                  itemCount: interestModelState.ignoredLists.length,
                  shrinkWrap: true,
                  itemBuilder: (context, index) {
                    final blockUser = interestModelState.ignoredLists[index];
