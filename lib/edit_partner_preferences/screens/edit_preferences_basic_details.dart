...
class PartnerPreferenceBasicDetailScreen extends ConsumerWidget {
  final Function(String? value) onPop;

  const PartnerPreferenceBasicDetailScreen({
    super.key,
    required this.onPop,
  });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildAgeSelection(context, ref, profileState),
                ...
                _buildMotherToungueSelection(context, ref, profileState),
  ...
  Widget _buildMotherToungueSelection(
    BuildContext context,
    WidgetRef ref,
    ProfileState profileState,
  ) {
